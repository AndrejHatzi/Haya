...
#remove var expr and add stmt
class BasicLexer(Lexer):
    tokens = { NAME, NUMBER, FLOAT, STRING, IF, ELSE, FOR, FASTERLOOP, WHILE, PRINT, FUN, TO, EQEQ, LEQ, DEL}
    ignore = '\t '
...
class BasicParser(Parser):
    ...
    @_('PRINT "(" statement ")"')
    def statement(self, p):
        return ('print_stmt_var', p.statement)
    ...
    @_('FASTERLOOP "(" var_assign TO expr ")" ":" statement')
    def statement(self, p):
